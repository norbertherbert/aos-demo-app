 ...
 * ----------------------------------------------------------------------------
 */
static cli_parser_status_t _cli_accelero_show_cmd(void *arg, int argc, char **argv)
{
...
static const cli_parser_cmd_t _system_cmd_table[] = {
		...
		PARSER_CMD_FUNC("accelero", "Accelerometer information", _cli_accelero_show_cmd, CLI_ACCESS_ALL_LEVELS),
		PARSER_CMD_END
};
